var customEmail = function (loginId, name, psw, state) {
  ...
  switch (state) {
    ...
    case "new-account":
      button = "";
      title = `Congratulations! Your have new Covid 19 Selfcare account. <br> Login using NIC and tempory Password below. <br> your tempory Password: ${psw}`;
      break;
    case "e-verify":
          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			<td class="logo" style="text-align: center;">
			            <h1><a href="#">COVID-19 Self-care</a></h1>
			          </td>
          		</tr>
          	</table>
          </td>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-right: 10px;">
                      	...
                      	<p>The Health Promotion Bureau (HPB) is the centre of excellence in Sri Lanka for health education, health promotion and publicity of health information. Empowering and mobilizing communities for the improvement of their quality of life through health promotion principles is the main achievement gained during the last few years.</p>
                      </td>
                    </tr>
                  </table>
                </td>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                      	...
                      	<ul>
					        <li><span class="text">No.2, Kynsey Road, Colombo 08, Sri Lanka</span></li>
